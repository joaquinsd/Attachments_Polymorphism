...
ActiveRecord::Schema.define(version: 2021_06_16_015557) do
  ...
  create_table "transbanks", force: :cascade do |t|
    t.string "transbankeable_type"
    t.integer "transbankeable_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["transbankeable_type", "transbankeable_id"], name: "index_transbanks_on_transbankeable_type_and_transbankeable_id"
  end
